...
const sendOTPEmail = async (email, otp) => {
    try {
        ...
        const mailOptions = {
            ...
            to: email,
            subject: 'Your OTP for EcoFinds Verification',
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 5px;">
                    <div style="text-align: center; margin-bottom: 20px;">
                        <h2 style="color: #333; margin: 0;">EcoFinds Verification Code</h2>
                    </div>
                    ...
                    <div style="color: #999; font-size: 12px; text-align: center;">
                        ...
                        <p style="margin: 5px 0 0 0;">© ${new Date().getFullYear()} EcoFinds. All rights reserved.</p>
                    </div>
                </div>
            `
        };
...
const resendOTPEmail = async (email, otp) => {
    try {
        ...
        const mailOptions = {
            from: process.env.EMAIL_FROM || process.env.EMAIL_USER,
            to: email,
            subject: 'Your New OTP for EcoFinds Verification',
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 5px;">
                    <div style="text-align: center; margin-bottom: 20px;">
                        <h2 style="color: #333; margin: 0;">New EcoFinds Verification Code</h2>
                    </div>
                    <div style="background-color: #f9f9f9; padding: 20px; border-radius: 5px; margin-bottom: 20px;">
