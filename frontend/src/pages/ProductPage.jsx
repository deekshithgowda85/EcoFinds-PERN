...
function ProductPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pb-8" id="featured-products">
          ...
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-black text-2xl font-bold">Featured Products</h2>

            {/* Search Input */}
            <div
              className="ml-8 p-5 overflow-hidden w-[60px] h-[60px] hover:w-[270px] bg-gray-100 shadow-[2px_2px_20px_rgba(0,0,0,0.08)] rounded-full flex group items-center hover:duration-300 duration-300"
            >
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-5 p-8">
            {/* Filter products based on searchQuery before mapping */}
            {products
              .filter(product =>
      ...
      {/* Render CartTab directly on ProductPage */}
      <CartTab />
    </div>
  );
}
